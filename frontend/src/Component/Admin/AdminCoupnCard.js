...
import DeleteCoponeHook from "../../Hook/Copone/DeleteCoponeHook";

export default function AdminCoupnCard({coupon}) {

    const [show,dateString, formatDate, handleShow, handleClose, handelDelete] = DeleteCoponeHook(coupon)
