...
import AdminAllCategoryHook from "../../Hook/Category/AdminAllCategoryHook";
...
export default function AdminAllCategory() {
    ...
    ] = AdminAllCategoryHook();

    return (
        <div>
            <div className="d-flex justify-content-between align-items-center">
                <div className="admin-conent-text">ادارة كل التصنيفات</div>
                <Link to="/admin/addcategory">
                    <div className="btn btn-dark btn-sm">اضف تصنيف</div>
                </Link>
            </div>
            ...
            <Modal show={showDelete} onHide={closeDelete}>
                ...
                <Modal.Body>هل انت متاكد من حذف التصنيف "{selected?.name}"؟</Modal.Body>
                <Modal.Footer>
            ...
            <Modal show={showEdit} onHide={closeEdit}>
                <Modal.Header><Modal.Title>تعديل التصنيف</Modal.Title></Modal.Header>
                <Modal.Body>
                    <input
                    ...
                    />
                    <label className="d-block mt-3 mb-1">صورة التصنيف (اختياري)</label>
                    <input
                        type="file"
                        accept="image/*"
                ...
                <Table responsive hover className="mt-3 text-center align-middle">
                    ...
                    <tbody>
                        {categories?.length >= 1 ? (
                            ...
                            <tr><td colSpan="4"><p className="empty">لا يوجد تصنيفات</p></td></tr>
                        )}
                    </tbody>
                </Table>
            )}
