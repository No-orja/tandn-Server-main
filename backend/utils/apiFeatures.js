// Chainable query builder for list endpoints: filter, search, sort, field
// limiting and pagination. Produces `paginationResult.numberOfPages`, the field
// the frontend reads to render page numbers.
class ApiFeatures {
